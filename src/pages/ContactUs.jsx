    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setError(null);
                setFormData({ name: '', email: '', number: '', address: '', message: '' }); // Reset form after successful submission
            }
        } catch (error) {
            ...
            <div className="flex-grow container mx-auto p-10 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg shadow-lg">
                ...
                <div className="flex justify-center">
                    <form className="w-full max-w-lg text-black" onSubmit={handleSubmit}>
                        ...
                        <div className="mb-6">
                            <label className="block text-gray-200 text-sm font-semibold mb-2" htmlFor="number">
                                Contact Number
                            </label>
                            <input
                                type="number"
                        ...
                        {/* Address field */}
                        <div className="mb-6">
                            <label className="block text-gray-200 text-sm font-semibold mb-2" htmlFor="address">
                                Address
                            </label>
                            <textarea
                                id="address"
