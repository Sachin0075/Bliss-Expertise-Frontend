...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            const response = await axios.get('http://127.0.0.1:5000/api/users/verify', {
            ...
            if (response.data && response.data.message === 'User verified successfully') {
                ...
                const userResponse = await axios.get("http://127.0.0.1:5000/api/users/details", {
                    params: { email },
                });

                console.log("User Details:", userResponse.data);
                const { name: userName, email: userEmail, address, phone, cart } = userResponse.data;
    ...
    return (
        ...
        >
            ...
            >
                <a href="#" className="flex items-center mb-6 text-4xl font-semibold text-white tracking-wider">
                    <motion.img
                ...
                >
                    ...
                    <div className="flex items-center justify-between mt-6">
                        <Link to="/register" className="text-sm text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-500">
                            Create an account
                        </Link>
                    </div>
                </motion.div>
