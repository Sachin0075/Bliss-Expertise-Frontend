...
const Home = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      price: '₹28,000',
      img: 'https://images.jdmagicbox.com/quickquotes/images_main/lg-1-0-ton-3-star-lwa12gwxa-window-ac-white-106489432-zbhji.jpg',
    },
    {
      name: 'Blue Star 1.5 Ton Split AC',
      price: '₹38,990',
      img: 'https://static.wixstatic.com/media/da977a_6d01fb1671d24bb6abbe7f414aaf2d12~mv2.jpg',
    },
    {
      name: 'Voltas 1.5 Ton Split AC',
      price: '₹36,500',
      img: 'https://m.media-amazon.com/images/I/61I6cDHskWL._SL1500_.jpg',
    },
  ]
      ...
      <section className="relative bg-gradient-to-r from-blue-500 to-purple-600 text-white h-screen flex items-center justify-center text-center p-10">
        ...
        >
          <h1 className="text-5xl font-extrabold mb-4">
            Welcome{username !== `Guest` ? `, ${username}` : `, Guest`} to Bliss
            Air Conditioning Services
          </h1>
          <p className="text-lg mb-6">
            Your one-stop solution for all AC sales, services, and repairs.
          </p>
          <Link
            to="/services"
            className="bg-white text-blue-600 px-6 py-3 rounded-xl font-semibold shadow-lg hover:bg-gray-200 transition"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {[
            ...
            },
            {
              title: 'Cooling Issue',
              icon: '❄️',
              description: 'Restore optimal cooling performance.',
            },
            {
              title: 'Maintenance',
              icon: '🛠️',
            ...
            },
            {
              title: 'Gas Filling',
              icon: '⛽',
              description: 'Top-quality gas refilling.',
            },
          ].map((service, index) => (
            <motion.div
              key={index}
