        ...
        <div className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input
                    ...
                    className="w-full p-4 border border-gray-300 rounded-lg"
                />
                {imgUrl && <img src={imgUrl} alt="Preview" className="w-32 h-32 object-cover mt-4" />}
                <button type="submit" className="w-full py-3 bg-green-500 text-white rounded-lg hover:bg-green-700 transition">
                    Add Product
                </button>
            </form>
        </div>
